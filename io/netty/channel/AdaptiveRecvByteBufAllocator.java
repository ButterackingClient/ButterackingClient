...
/*     */   }
/*     */   
/*  61 */   public static final AdaptiveRecvByteBufAllocator DEFAULT = new AdaptiveRecvByteBufAllocator(); private final int minIndex; private final int maxIndex; private final int initial;
/*     */   
/*     */   private static int getSizeTableIndex(int size) {
/*  64 */     int mid, a, low = 0, high = SIZE_TABLE.length - 1; while (true) {
/*  65 */       if (high < low) {
/*  66 */         return low;
/*     */       }
/*  68 */       if (high == low) {
...
/*  75 */       if (size > b) {
/*  76 */         low = mid + 1; continue;
/*  77 */       }  if (size < a)
/*  78 */       { high = mid - 1; continue; }  break;
/*  79 */     }  if (size == a) {
/*  80 */       return mid;
/*     */     }
/*  82 */     return mid + 1;
