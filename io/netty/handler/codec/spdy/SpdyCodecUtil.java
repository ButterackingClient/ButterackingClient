...
/* 245 */     return (buf.getByte(offset) & 0xFF) << 8 | buf.getByte(offset + 1) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 253 */     return (buf.getByte(offset) & 0xFF) << 16 | (buf.getByte(offset + 1) & 0xFF) << 8 | buf.getByte(offset + 2) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 262 */     return (buf.getByte(offset) & Byte.MAX_VALUE) << 24 | (buf.getByte(offset + 1) & 0xFF) << 16 | (buf.getByte(offset + 2) & 0xFF) << 8 | buf.getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */     return (buf.getByte(offset) & 0xFF) << 24 | (buf.getByte(offset + 1) & 0xFF) << 16 | (buf.getByte(offset + 2) & 0xFF) << 8 | buf.getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/* 293 */     if (name.isEmpty()) {
/* 294 */       throw new IllegalArgumentException("name cannot be length zero");
/*     */     }
/*     */ 
/*     */ 
/*     */     
/* 299 */     if (name.length() > 65535) {
/* 300 */       throw new IllegalArgumentException("name exceeds allowable length: " + name);
/*     */     }
/*     */     
/* 303 */     for (int i = 0; i < name.length(); i++) {
/* 304 */       char c = name.charAt(i);
/* 305 */       if (c == '\000') {
/* 306 */         throw new IllegalArgumentException("name contains null character: " + name);
/*     */       }
/*     */       
/* 309 */       if (c > '') {
/* 310 */         throw new IllegalArgumentException("name contains non-ascii character: " + name);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 320 */     if (value == null) {
/* 321 */       throw new NullPointerException("value");
/*     */     }
/* 323 */     for (int i = 0; i < value.length(); i++) {
/* 324 */       char c = value.charAt(i);
/* 325 */       if (c == '\000')
/* 326 */         throw new IllegalArgumentException("value contains null character: " + value); 
/*     */     } 
/*     */   }
/*     */ }
