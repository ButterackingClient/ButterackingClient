...
/*  65 */       Setting setting = this.settingsMap.get(key);
...
/* 139 */       Setting setting = e.getValue();
/* 140 */       buf.append("--> ");
...
/* 156 */     buf.append(StringUtil.simpleClassName(this));
/* 157 */     buf.append(StringUtil.NEWLINE);
...
/* 171 */       this.persist = persist;
/* 172 */       this.persisted = persisted;
/*     */     }
/*     */     
/*     */     int getValue() {
