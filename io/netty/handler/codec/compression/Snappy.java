...
/*     */           
/* 100 */           int candidate = baseIndex + table[hash];
/*     */           
/* 102 */           table[hash] = (short)(inIndex - baseIndex);
/*     */           
/* 104 */           if (in.getInt(inIndex) == in.getInt(candidate)) {
/*     */             
...
/*     */               
/* 128 */               if (in.getInt(insertTail + 1) != in.getInt(candidate))
/*     */               
...
/* 281 */       int uncompressedLength; int literalWritten; int decodeWritten; switch (this.state) {
/*     */         case READY:
/* 283 */           this.state = State.READING_PREAMBLE;
/*     */         case READING_PREAMBLE:
/* 285 */           uncompressedLength = readPreamble(in);
...
/* 314 */           literalWritten = decodeLiteral(this.tag, in, out);
