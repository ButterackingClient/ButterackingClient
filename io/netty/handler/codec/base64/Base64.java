...
/* 229 */       byte sbiCrop = (byte)(src.getByte(i) & Byte.MAX_VALUE);
...
/*     */       
/* 264 */       outBuff = (DECODABET[src[srcOffset]] & 0xFF) << 18 | (DECODABET[src[srcOffset + 1]] & 0xFF) << 12;
/*     */ 
/*     */ 
/*     */       
...
/*     */       
/* 272 */       outBuff = (DECODABET[src[srcOffset]] & 0xFF) << 18 | (DECODABET[src[srcOffset + 1]] & 0xFF) << 12 | (DECODABET[src[srcOffset + 2]] & 0xFF) << 6;
/*     */ 
/*     */ 
/*     */ 
/*     */       
