...
/*     */     
/*     */     try {
/* 107 */       arrayOfString = OpenJdkSelfSignedCertGenerator.generate(fqdn, keypair, random);
/* 108 */     } catch (Throwable t) {
/* 109 */       logger.debug("Failed to generate a self-signed X.509 certificate using sun.security.x509:", t);
/*     */       
/*     */       try {
/* 112 */         arrayOfString = BouncyCastleSelfSignedCertGenerator.generate(fqdn, keypair, random);
