...
/* 115 */     assert (this.bitmap[q] >>> r & 0x1L) != 0L;
/* 116 */     this.bitmap[q] = this.bitmap[q] ^ 1L << r;
/*     */     
...
/* 176 */       if ((bits ^ 0xFFFFFFFFFFFFFFFFL) != 0L) {
...
/* 202 */     return 0x4000000000000000L | bitmapIdx << 32L | this.memoryMapIdx;
/*     */   }
/*     */   
