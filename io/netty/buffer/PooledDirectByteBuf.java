...
/*  71 */     index = idx(index);
/*  72 */     return (this.memory.get(index) & 0xFF) << 16 | (this.memory.get(index + 1) & 0xFF) << 8 | this.memory.get(index + 2) & 0xFF;
/*     */   }
/*     */ 
/*     */   
/*     */   protected int _getInt(int index) {
/*  77 */     return this.memory.getInt(idx(index));
/*     */   }
/*     */ 
/*     */   
/*     */   protected long _getLong(int index) {
/*  82 */     return this.memory.getLong(idx(index));
/*     */   }
/*     */ 
/*     */   
...
/*     */     } else {
/* 114 */       tmpBuf = this.memory.duplicate();
/*     */     } 
/* 116 */     index = idx(index);
...
/*     */     } else {
/* 142 */       tmpBuf = this.memory.duplicate();
/*     */     } 
/* 144 */     index = idx(index);
...
/*     */     } else {
/* 175 */       tmpBuf = this.memory.duplicate();
/*     */     } 
...
/*     */     } else {
/* 205 */       tmpBuf = this.memory.duplicate();
/*     */     } 
/* 207 */     index = idx(index);
...
/* 222 */     this.memory.put(idx(index), (byte)value);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _setShort(int index, int value) {
/* 227 */     this.memory.putShort(idx(index), (short)value);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _setMedium(int index, int value) {
/* 232 */     index = idx(index);
/* 233 */     this.memory.put(index, (byte)(value >>> 16));
/* 234 */     this.memory.put(index + 1, (byte)(value >>> 8));
/* 235 */     this.memory.put(index + 2, (byte)value);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _setInt(int index, int value) {
/* 240 */     this.memory.putInt(idx(index), value);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _setLong(int index, long value) {
/* 245 */     this.memory.putLong(idx(index), value);
/*     */   }
/*     */ 
/*     */   
...
/* 332 */     index = idx(index);
/* 333 */     return ((ByteBuffer)this.memory.duplicate().position(index).limit(index + length)).slice();
/*     */   }
/*     */ 
/*     */   
