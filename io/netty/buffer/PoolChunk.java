...
/* 186 */     return (PoolSubpage<T>[])new PoolSubpage[size];
/*     */   }
/*     */   
/*     */   int usage() {
...
/* 278 */     assert value == d && (id & initial) == 1 << d : String.format("val = %d, id & initial = %d, d = %d", new Object[] { Byte.valueOf(value), Integer.valueOf(id & initial), Integer.valueOf(d) });
/*     */     
...
/* 341 */     int bitmapIdx = (int)(handle >>> 32L);
/*     */     
/* 343 */     if (bitmapIdx != 0) {
...
/* 357 */     int bitmapIdx = (int)(handle >>> 32L);
/* 358 */     if (bitmapIdx == 0) {
...
/* 368 */     initBufWithSubpage(buf, handle, (int)(handle >>> 32L), reqCapacity);
/*     */   }
/*     */   
...
/* 420 */     buf.append("Chunk(");
/* 421 */     buf.append(Integer.toHexString(System.identityHashCode(this)));
/* 422 */     buf.append(": ");
/* 423 */     buf.append(usage());
/* 424 */     buf.append("%, ");
/* 425 */     buf.append(this.chunkSize - this.freeBytes);
/* 426 */     buf.append('/');
/* 427 */     buf.append(this.chunkSize);
/* 428 */     buf.append(')');
