...
/* 341 */     return (this.array[index] & 0xFFL) << 56L | (this.array[index + 1] & 0xFFL) << 48L | (this.array[index + 2] & 0xFFL) << 40L | (this.array[index + 3] & 0xFFL) << 32L | (this.array[index + 4] & 0xFFL) << 24L | (this.array[index + 5] & 0xFFL) << 16L | (this.array[index + 6] & 0xFFL) << 8L | this.array[index + 7] & 0xFFL;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 414 */     this.array[index] = (byte)(int)(value >>> 56L);
/* 415 */     this.array[index + 1] = (byte)(int)(value >>> 48L);
/* 416 */     this.array[index + 2] = (byte)(int)(value >>> 40L);
/* 417 */     this.array[index + 3] = (byte)(int)(value >>> 32L);
/* 418 */     this.array[index + 4] = (byte)(int)(value >>> 24L);
/* 419 */     this.array[index + 5] = (byte)(int)(value >>> 16L);
/* 420 */     this.array[index + 6] = (byte)(int)(value >>> 8L);
