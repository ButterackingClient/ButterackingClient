...
/*  68 */     this.memoryAddress = PlatformDependent.directBufferAddress(this.memory) + this.offset;
/*     */   }
/*     */ 
/*     */   
...
/*     */     } else {
/* 162 */       tmpBuf = this.memory.duplicate();
/*     */     } 
/* 164 */     index = idx(index);
...
/*     */     } else {
/* 204 */       tmpBuf = this.memory.duplicate();
/*     */     } 
/* 206 */     index = idx(index);
...
/* 345 */     index = idx(index);
/* 346 */     return ((ByteBuffer)this.memory.duplicate().position(index).limit(index + length)).slice();
/*     */   }
/*     */ 
/*     */   
...
/* 382 */     return this.memoryAddress + index;
/*     */   }
/*     */ 
/*     */   
