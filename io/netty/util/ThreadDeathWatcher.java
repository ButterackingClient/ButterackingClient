...
/*  43 */   private static final ThreadFactory threadFactory = (ThreadFactory)new DefaultThreadFactory(ThreadDeathWatcher.class, true, 1);
/*     */ 
/*     */   
...
/*     */     implements Runnable
/*     */   {
/* 124 */     private final List<ThreadDeathWatcher.Entry> watchees = new ArrayList<ThreadDeathWatcher.Entry>();
/*     */ 
/*     */     
/*     */     public void run() {
/*     */       while (true) {
...
/*     */       while (true) {
/* 175 */         ThreadDeathWatcher.Entry e = ThreadDeathWatcher.pendingEntries.poll();
/* 176 */         if (e == null) {
/*     */           break;
/*     */         }
/*     */         
/* 180 */         if (e.isWatch) {
/* 181 */           this.watchees.add(e); continue;
/*     */         } 
...
/* 191 */         ThreadDeathWatcher.Entry e = watchees.get(i);
