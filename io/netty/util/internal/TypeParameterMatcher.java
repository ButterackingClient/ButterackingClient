...
/*  93 */         TypeVariable[] arrayOfTypeVariable = currentClass.getSuperclass().getTypeParameters();
/*  94 */         for (int i = 0; i < arrayOfTypeVariable.length; i++) {
/*  95 */           if (typeParamName.equals(arrayOfTypeVariable[i].getName())) {
/*  96 */             typeParamIndex = i;
/*     */             
/*     */             break;
/*     */           } 
