...
/*     */ {
/*  37 */   public static final Object UNSET = new Object(); public long rp1; public long rp2; public long rp3; public long rp4;
/*     */   public static InternalThreadLocalMap getIfSet() {
/*     */     InternalThreadLocalMap threadLocalMap;
/*  40 */     Thread thread = Thread.currentThread();
/*     */     
/*  42 */     if (thread instanceof FastThreadLocalThread) {
/*  43 */       threadLocalMap = ((FastThreadLocalThread)thread).threadLocalMap();
/*     */     } else {
...
/*  57 */     if (thread instanceof FastThreadLocalThread) {
/*  58 */       return fastGet((FastThreadLocalThread)thread);
/*     */     }
/*  60 */     return slowGet();
/*     */   }
/*     */ 
...
/*  75 */       UnpaddedInternalThreadLocalMap.slowThreadLocalMap = slowThreadLocalMap = new ThreadLocal<InternalThreadLocalMap>();
/*     */     }
/*     */ 
/*     */     
...
/*  89 */     if (thread instanceof FastThreadLocalThread) {
/*  90 */       ((FastThreadLocalThread)thread).setThreadLocalMap(null);
/*     */     } else {
...
/* 187 */     if (cache == null) {
/* 188 */       this.charsetEncoderCache = cache = new IdentityHashMap<Charset, CharsetEncoder>();
/*     */     }
/* 190 */     return cache;
/*     */   }
/*     */   
...
/* 195 */     if (cache == null) {
/* 196 */       this.charsetDecoderCache = cache = new IdentityHashMap<Charset, CharsetDecoder>();
/*     */     }
/* 198 */     return cache;
/*     */   }
/*     */   
...
/* 219 */     if (cache == null) {
/* 220 */       this.typeParameterMatcherGetCache = cache = new IdentityHashMap<Class<?>, TypeParameterMatcher>();
/*     */     }
/* 222 */     return cache;
/*     */   }
/*     */   
...
/* 227 */     if (cache == null) {
/* 228 */       this.typeParameterMatcherFindCache = cache = new IdentityHashMap<Class<?>, Map<String, TypeParameterMatcher>>();
/*     */     }
/* 230 */     return cache;
/*     */   }
/*     */   
...
/* 243 */     if (cache == null)
/*     */     {
/* 245 */       this.handlerSharableCache = cache = new WeakHashMap<Class<?>, Boolean>(4);
/*     */     }
/* 247 */     return cache;
/*     */   }
/*     */   
