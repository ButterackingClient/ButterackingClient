...
/*  31 */   private float offset = 1.0E-6F;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 287 */     if (1.0E-6F > (f2 - f) * (f5 - f1) - (f3 - f1) * (f4 - f))
/* 288 */       return false; 
