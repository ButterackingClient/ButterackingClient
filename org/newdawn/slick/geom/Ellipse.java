...
/* 120 */     ArrayList<Float> tempPoints = new ArrayList();
/*     */     
/* 122 */     this.maxX = -1.4E-45F;
/* 123 */     this.maxY = -1.4E-45F;
/* 124 */     this.minX = Float.MAX_VALUE;
/* 125 */     this.minY = Float.MAX_VALUE;
/*     */     
...
/*     */     float a;
/* 135 */     for (a = start; a <= end + step; a += step) {
/* 136 */       float ang = a;
/* 137 */       if (ang > end) {
/* 138 */         ang = end;
/*     */       }
