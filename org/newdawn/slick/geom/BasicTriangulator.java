...
/*  56 */     return new float[] { Point.access$000(this.poly.get(index)), Point.access$100(this.poly.get(index)) };
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 187 */     if (1.0E-10F > (Bx - Ax) * (Cy - Ay) - (By - Ay) * (Cx - Ax)) {
/* 188 */       return false;
/*     */     }
/*     */     
...
/*     */ 
/*     */         
/* 275 */         for (int s = v, t = v + 1; t < nv; s++, t++) {
/* 276 */           V[s] = V[t];
/*     */         }
/* 278 */         nv--;
/*     */ 
