...
/* 37 */     this.original = (Image)new BigImage("testdata/bigimage.tga", 2, 256);
...
/*    */     try {
/* 73 */       AppGameContainer container = new AppGameContainer((Game)new BigSpriteSheetTest());
