...
/* 71 */     g.texture((Shape)this.poly, this.image);
/*    */     
/* 73 */     ShapeRenderer.texture((Shape)this.poly, this.image, this.texPaint);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */     try {
/* 83 */       AppGameContainer container = new AppGameContainer((Game)new TexturePaintTest());
