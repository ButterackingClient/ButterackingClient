...
/*  53 */     this.original = this.image = (Image)new BigImage("testdata/bigimage.tga", 2, 512);
...
/*     */     try {
/*  88 */       AppGameContainer container = new AppGameContainer((Game)new BigImageTest());
