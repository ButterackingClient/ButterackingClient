...
/*  82 */     g.draw((Shape)this.curve);
/*  83 */     g.fill((Shape)this.curve);
/*     */     
/*  85 */     g.draw((Shape)this.poly);
/*  86 */     g.fill((Shape)this.poly);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     try {
/*  96 */       AppGameContainer container = new AppGameContainer((Game)new CurveTest());
