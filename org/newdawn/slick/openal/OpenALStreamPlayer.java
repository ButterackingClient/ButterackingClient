...
/* 232 */           Log.error("Failed to loop buffer: " + bufferId + " " + format + " " + count + " " + this.audio.getRate(), (Throwable)e);
/* 233 */           return false;
/*     */         }
/*     */       
...
/* 276 */           this.positionOffset += bufferLength; continue;
/*     */         } 
/* 278 */         if (this.loop) {
/* 279 */           initStreams();
/*     */         } else {
