...
/* 100 */             AppletGameContainer.this.add(new AppletGameContainer.ConsolePanel(e));
...
/* 448 */         if (fullscreen) {
/*     */           
/* 450 */           int newWidth, newHeight, screenWidth = Display.getDisplayMode().getWidth();
