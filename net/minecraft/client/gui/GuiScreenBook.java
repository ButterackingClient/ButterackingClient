...
/*     */       
/* 120 */       this.buttonList.add(this.buttonSign = new GuiButton(3, width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.signButton", new Object[0])));
/* 121 */       this.buttonList.add(this.buttonDone = new GuiButton(0, width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.done", new Object[0])));
/* 122 */       this.buttonList.add(this.buttonFinalize = new GuiButton(5, width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
/* 123 */       this.buttonList.add(this.buttonCancel = new GuiButton(4, width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.cancel", new Object[0])));
/*     */     }
/*     */     else {
/*     */       
/* 127 */       this.buttonList.add(this.buttonDone = new GuiButton(0, width / 2 - 100, 4 + this.bookImageHeight, 200, 20, I18n.format("gui.done", new Object[0])));
/*     */     } 
/*     */     
/* 130 */     int i = (width - this.bookImageWidth) / 2;
/* 131 */     int j = 2;
...
/* 413 */     int i = (width - this.bookImageWidth) / 2;
/* 414 */     int j = 2;
...
/* 476 */             this.field_175386_A = (ichatcomponent != null) ? GuiUtilRenderComponents.splitText(ichatcomponent, 116, this.fontRendererObj, true, true) : null;
/*     */           }
...
/* 546 */     ClickEvent clickevent = (component == null) ? null : component.getChatStyle().getChatClickEvent();
/*     */     
/* 548 */     if (clickevent == null)
/*     */     {
/* 550 */       return false;
/*     */     }
/* 552 */     if (clickevent.getAction() == ClickEvent.Action.CHANGE_PAGE) {
/*     */       
/* 554 */       String s = clickevent.getValue();
/*     */ 
/*     */       
/*     */       try {
/* 558 */         int i = Integer.parseInt(s) - 1;
/*     */         
/* 560 */         if (i >= 0 && i < this.bookTotalPages && i != this.currPage)
/*     */         {
/* 562 */           this.currPage = i;
/* 563 */           updateButtons();
/* 564 */           return true;
...
/*     */ 
/*     */     
/* 576 */     boolean flag = super.handleComponentClick(component);
/*     */     
/* 578 */     if (flag && clickevent.getAction() == ClickEvent.Action.RUN_COMMAND)
/*     */     {
/* 580 */       this.mc.displayGuiScreen(null);
/*     */     }
/*     */     
/* 583 */     return flag;
/*     */   }
...
/* 589 */     if (this.field_175386_A == null)
/*     */     {
/* 591 */       return null;
/*     */     }
/*     */ 
/*     */     
/* 595 */     int i = p_175385_1_ - (width - this.bookImageWidth) / 2 - 36;
/* 596 */     int j = p_175385_2_ - 2 - 16 - 16;
/*     */     
/* 598 */     if (i >= 0 && j >= 0) {
/*     */       
/* 600 */       int k = Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.field_175386_A.size());
/*     */       
/* 602 */       if (i <= 116 && j < this.mc.fontRendererObj.FONT_HEIGHT * k + k) {
/*     */         
/* 604 */         int l = j / this.mc.fontRendererObj.FONT_HEIGHT;
/*     */         
/* 606 */         if (l >= 0 && l < this.field_175386_A.size()) {
/*     */           
/* 608 */           IChatComponent ichatcomponent = this.field_175386_A.get(l);
/* 609 */           int i1 = 0;
/*     */           
/* 611 */           for (IChatComponent ichatcomponent1 : ichatcomponent) {
/*     */             
/* 613 */             if (ichatcomponent1 instanceof ChatComponentText) {
/*     */               
/* 615 */               i1 += this.mc.fontRendererObj.getStringWidth(((ChatComponentText)ichatcomponent1).getChatComponentText_TextValue());
/*     */               
/* 617 */               if (i1 > i)
/*     */               {
/* 619 */                 return ichatcomponent1;
/*     */               }
/*     */             } 
/*     */           } 
/*     */         } 
...
/* 645 */       super(p_i46316_1_, p_i46316_2_, p_i46316_3_, 23, 13, "");
/* 646 */       this.field_146151_o = p_i46316_4_;
/*     */     }
/*     */ 
/*     */     
...
/* 651 */       if (this.visible) {
/*     */         
/* 653 */         boolean flag = (mouseX >= this.xPosition && mouseY >= this.yPosition && mouseX < this.xPosition + this.width && mouseY < this.yPosition + this.height);
/* 654 */         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
/* 655 */         mc.getTextureManager().bindTexture(GuiScreenBook.bookGuiTextures);
/* 656 */         int i = 0;
/* 657 */         int j = 192;
/*     */         
/* 659 */         if (flag)
...
/*     */         }
/*     */         
/* 664 */         if (!this.field_146151_o)
/*     */         {
/* 666 */           j += 13;
/*     */         }
/*     */         
/* 669 */         drawTexturedModalRect(this.xPosition, this.yPosition, i, j, 23, 13);
/*     */       } 
/*     */     }
/*     */   }
/*     */ }
