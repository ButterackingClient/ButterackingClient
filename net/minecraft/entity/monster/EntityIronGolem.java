...
/* 264 */       super(creature, classTarget, chance, p_i45858_4_, p_i45858_5_, p_i45858_6_);
/* 265 */       this.targetEntitySelector = new Predicate<T>() {
/*     */           public boolean apply(T p_apply_1_) {
/* 267 */             if (p_i45858_6_ != null && !p_i45858_6_.apply(p_apply_1_))
/* 268 */               return false; 
/* 269 */             if (p_apply_1_ instanceof EntityCreeper) {
/* 270 */               return false;
/*     */             }
/* 272 */             if (p_apply_1_ instanceof EntityPlayer) {
/* 273 */               double d0 = EntityIronGolem.AINearestAttackableTargetNonCreeper.this.getTargetDistance();
/*     */               
/* 275 */               if (p_apply_1_.isSneaking()) {
/* 276 */                 d0 *= 0.800000011920929D;
/*     */               }
/*     */               
/* 279 */               if (p_apply_1_.isInvisible()) {
/* 280 */                 float f = ((EntityPlayer)p_apply_1_).getArmorVisibility();
/*     */                 
/* 282 */                 if (f < 0.1F) {
/* 283 */                   f = 0.1F;
/*     */                 }
...
/*     */               } 
/*     */               
/* 289 */               if (p_apply_1_.getDistanceToEntity((Entity)creature) > d0) {
/* 290 */                 return false;
/*     */               }
/*     */             } 
/*     */             
/* 294 */             return EntityIronGolem.AINearestAttackableTargetNonCreeper.this.isSuitableTarget((EntityLivingBase)p_apply_1_, false);
/*     */           }
/*     */         };
/*     */     }
/*     */   }
