...
/*     */ 
/*     */     
/* 103 */     List<String> list = Lists.newArrayList(); byte b; int i;
/*     */     EnumParticleTypes[] arrayOfEnumParticleTypes;
/* 105 */     for (i = (arrayOfEnumParticleTypes = values()).length, b = 0; b < i; ) { EnumParticleTypes enumparticletypes = arrayOfEnumParticleTypes[b];
/* 106 */       PARTICLES.put(Integer.valueOf(enumparticletypes.getParticleID()), enumparticletypes);
/*     */       
/* 108 */       if (!enumparticletypes.getParticleName().endsWith("_")) {
/* 109 */         list.add(enumparticletypes.getParticleName());
/*     */       }
/*     */       b++; }
/*     */     
/* 113 */     PARTICLE_NAMES = list.<String>toArray(new String[list.size()]);
/*     */   }
/*     */   
