...
/*     */ 
/*     */     
/*  42 */     formattingCodePattern = Pattern.compile("(?i)" + String.valueOf('§') + "[0-9A-FK-OR]");
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 164 */     for (i = (arrayOfEnumChatFormatting = values()).length, b = 0; b < i; ) { EnumChatFormatting enumchatformatting = arrayOfEnumChatFormatting[b];
/* 165 */       nameMapping.put(func_175745_c(enumchatformatting.name), enumchatformatting);
/*     */       b++; }
/*     */   
/*     */   }
/*     */   
