...
/* 13 */     return (other == null) ? false : ((this == other));
/*    */   }
/*    */ 
/*    */   
...
/* 34 */     ALWAYS("always", 0),
/* 35 */     NEVER("never", 1),
/* 36 */     HIDE_FOR_OTHER_TEAMS("hideForOtherTeams", 2),
/* 37 */     HIDE_FOR_OWN_TEAM("hideForOwnTeam", 3);
/*    */     
/* 39 */     private static Map<String, EnumVisible> field_178828_g = Maps.newHashMap();
/*    */ 
/*    */ 
/*    */ 
/*    */     
...
/* 57 */       for (i = (arrayOfEnumVisible = values()).length, b = 0; b < i; ) { EnumVisible team$enumvisible = arrayOfEnumVisible[b];
